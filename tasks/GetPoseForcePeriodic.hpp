...
#ifndef ADAP_SAMPLES_INPUT_GETPOSEFORCEPERIODIC_TASK_HPP
#define ADAP_SAMPLES_INPUT_GETPOSEFORCEPERIODIC_TASK_HPP

#include "adap_samples_input/GetPoseForcePeriodicBase.hpp"
#include "adap_samples_input/DataModel.hpp"

namespace adap_samples_input {

    /*! \class GetPoseForcePeriodic 
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','adap_samples_input::GetPoseForcePeriodic')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class GetPoseForcePeriodic : public GetPoseForcePeriodicBase
    {
    ...
    public:
        /** TaskContext constructor for GetPoseForcePeriodic
         * \param name Name of the task. This name needs to be unique to make it identifiable via nameservices.
         * \param initial_state The initial TaskState of the TaskContext. Default is Stopped state.
         */
        GetPoseForcePeriodic(std::string const& name = "adap_samples_input::GetPoseForcePeriodic");
         ...
         * 
         */
        GetPoseForcePeriodic(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of GetPoseForcePeriodic
         */
	~GetPoseForcePeriodic();
